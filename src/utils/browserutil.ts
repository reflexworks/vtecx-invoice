...
/**
 * 指定した apiAction のキャッシュをすべて削除する
 * POST/DELETE 等の更新操作後に呼び出すことで、次の GET が最新データを取得できる
 */
export const clearApiCache = (apiAction: string) => {
  const prefix = CACHE_KEY_PREFIX + `GET:${apiAction}:`
